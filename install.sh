...
sudo docker run -d --net=host -e TZ=Europe/Paris -v /home/mail:/data --name "$CONTAINER_NAME" -h "$DOMAIN" -e "HTTP_PORT=8080" -e "HTTPS_PORT=4433" -e "DISABLE_CLAMAV=TRUE" -t analogic/poste.io
